...
For a repetitive dive, in addition to the
...
.. Test case: `delete 1` +
   Expected: First dive session is deleted from the list. Details of the deleted dive session shown in the status message. Timestamp in the status bar is updated.
.. Test case: `delete 0` +
