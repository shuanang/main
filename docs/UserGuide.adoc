...
By: `Team W13-2`      Since: `September 2018`      Licence: `MIT`
...
image::./UGScreenshots/help1.png[width="800"]
Diagram 3: Enter the help command in the command box

image::./UGScreenshots/help2.png[width="800"]
...
image::./UGScreenshots/help3.png[width="800"]
