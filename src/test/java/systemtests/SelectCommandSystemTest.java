...
import static seedu.divelog.commons.core.Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
...
public class SelectCommandSystemTest extends DiveLogSystemTest {
    @Test
    public void select() {
