...
public class DiveSessionCardTest extends GuiUnitTest {
    ...
    public void equals() {
        ...
        DiveSessionCard copy = new DiveSessionCard(person, 0);
        ...
        assertFalse(personCard.equals(new DiveSessionCard(person, 1)));
    }
     ...
     * {@code expectedId}.
     */
    private void assertCardDisplay(DiveSessionCard personCard, Person expectedPerson, int expectedId) {
