package seedu.divelog.commons.core.index;
...
public class IndexTest {
    ...
    @Test
    public void equals() {
        final Index fifthDiveSessionIndex = Index.fromOneBased(5);

        // same values -> returns true
        assertTrue(fifthDiveSessionIndex.equals(Index.fromOneBased(5)));
        assertTrue(fifthDiveSessionIndex.equals(Index.fromZeroBased(4)));

        // same object -> returns true
        assertTrue(fifthDiveSessionIndex.equals(fifthDiveSessionIndex));

        // null -> returns false
        assertFalse(fifthDiveSessionIndex.equals(null));

        // different types -> returns false
        assertFalse(fifthDiveSessionIndex.equals(5.0f));

        // different index -> returns false
        assertFalse(fifthDiveSessionIndex.equals(Index.fromOneBased(1)));
    }
}
